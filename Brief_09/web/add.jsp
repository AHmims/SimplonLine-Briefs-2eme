...
<body>
    ...
    <div class="px-24 lg:px-32 xl:px-96 w-full max-w-8xl mx-auto">
        ...
        <div class="flex flex-col items-center">
            <% if (res) { %>
            <span class="py-4 px-12 bg-green-100 rounded-lg ring-4 ring-green-400 ring-inset text-green-900 font-medium mb-4 -mt-4">Pepiniere ajoute avec succès</span>
            <% } else { %>
            <span class="py-4 px-12 bg-red-100 rounded-lg ring-4 ring-red-400 ring-inset text-red-900 font-medium mb-4 -mt-4">Pepiniere n'a pas été ajoutée</span>
            <% } %>
        </div>
        <% } %>
