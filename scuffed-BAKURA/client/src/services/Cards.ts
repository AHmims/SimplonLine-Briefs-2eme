...
function getAllCards(page = 0 as Number, size = 25 as Number, cardType = 'all' as String, archetype = '' as String): Promise<CustomResponse> {
...
function searchForCards(searchText: String, page = 0 as Number, size = 25 as Number, cardType = 'all' as String): Promise<CustomResponse> {
  return new Promise((resolve, reject) => {
    // @ts-ignore
