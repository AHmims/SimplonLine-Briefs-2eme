...
public class Main2 {
    ...
    //
    private static ArrayList livres = new ArrayList<Livre>();
    private static ArrayList lecteurs = new ArrayList<Lecteur>();
    private static ArrayList bienfaiteurs = new ArrayList<Bienfaiteur>();
        ...
        switch (choix) {
            case 1:
                if (bienfaiteurs.size() > 0) {
                    ...
                    for (int i = 0; i < bienfaiteurs.size(); i++) {
                        Bienfaiteur bienfaiteur = (Bienfaiteur) bienfaiteurs.get(i);
                        System.out.printf("%d: %s\n", i, bienfaiteur.getSurnom());
                    }
                    System.out.println("---\n0: Annuler");
                    int choixB = -1;
                    while (choixB != 0) {
                        ...
                        choixB = sc.nextInt();
                        if (choixB != 0) {
                            if (bienfaiteurs.size() > choixB - 1) {
                                int idB = ((Bienfaiteur) bienfaiteurs.get(choixB - 1)).getIdentifiant();
                                ((Bienfaiteur) bienfaiteurs.get(choixB - 1)).getCarteFidelite().ajouterPoint();
                                //
                                livres.add(new Livre(titre, edition, idB, dateEdition));
            ...
            case 2:
                ...
                //
                lecteurs.add(new Lecteur(nom, prenom, numTel, mail_L));
            ...
            case 3:
                ...
                //
                bienfaiteurs.add(new Bienfaiteur(surnom, mail_B));
        ...
        switch (choix) {
                    ...
                    if (choix_L != 0) {
                        if (livres.size() > choix_L - 1) {
                            ...
                            while (choixB != 0) {
                                ...
                                if (choixB != 0) {
                                    if (choixB == -1) {
                                        ((Livre) livres.get(choix_L - 1)).modifier(titre, edition, -1, dateEdition);
                                        System.out.println("Livre modifié avec succès.");
                                        choixB = 0;
                                    } else if (bienfaiteurs.size() > choixB - 1) {
                                        int idB = ((Bienfaiteur) bienfaiteurs.get(choixB - 1)).getIdentifiant();
                                        //
                                        ((Livre) livres.get(choix_L - 1)).modifier(titre, edition, idB, dateEdition);
                                        System.out.println("Livre modifié avec succès.");
                                        choixB = 0;
                                    } else
                                        System.out.println("---\nChoix invalide!\n---");
                ...
                while (choix_LT != 0) {
                    ...
                    if (choix_LT != 0) {
                        if (lecteurs.size() > choix_LT - 1) {
                            ...
                            String mail_L = sc.next();
                            //
                            ((Lecteur) lecteurs.get(choix_LT - 1)).modifier(nom, prenom, numTel, mail_L);
            ...
            case 3:
                ...
                while (choix_B != 0) {
                    ...
                    //
                    if (choix_B != 0) {
                        if (bienfaiteurs.size() > choix_B - 1) {
                            System.out.println("_** Laissez le champ vide si vous ne voulez pas le modifier **_");
                            System.out.print("Surnom : ");
                            String surnom = sc.nextLine();
                            System.out.print("Adresse email : ");
                            String mail_B = sc.nextLine();
                            //
                            ((Bienfaiteur) bienfaiteurs.get(choix_B - 1)).modifier(surnom, mail_B);
    ...
    public static void supprimer(int choix) {
        ...
        while (choix_D != 0) {
            ...
            if (choix_D != 0) {
                switch (choix) {
                    case 1:
                        if (livres.size() > choix_D - 1 && choix_D > 0) {
                        ...
                        break;
                    case 2:
                        if (lecteurs.size() > choix_D - 1 && choix_D > 0) {
