                ...
                <div class="flex-1 flex flex-col justify-between space-y-20">
                    ...
                    <div class="flex flex-col space-y-10">
                        ...
                        <div id="articlesContainer" class="w-full grid grid-cols-article gap-13">
                            ...
                            <% } %>
                            <% } %>
                            <div data-article="<%= article.getIdarticle() %>" class="articleCard bg-white h-420 rounded-50 border-3 border-coolGray-100 flex flex-col p-7 justify-between">
                                <!-- Top -->
                                <div class="relative w-full h-64">
                                    ...
                                    <div class="flex flex-col absolute bottom-0 right-0 space-y-2.5">
                                        ...
                                        <button data-article="<%= article.getIdarticle() %>" data-toggle="<%=voted %>" data-display="no" class="voteBtn p-3 <%= voted ? "bg-red-50" : "bg-coolGray-100"%> rounded-20">
                                            <svg data-display="no" width="30" height="30" class="fill-current <%= voted ? "text-red-500" : "text-coolGray-300"%>" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path data-display="no" fill-rule="evenodd" clip-rule="evenodd" d="M4.758 7.758C5.88317 6.63317 7.40902 6.00128 9 6.00128C10.591 6.00128 12.1168 6.63317 13.242 7.758L15 9.5145L16.758 7.758C17.3115 7.18494 17.9735 6.72784 18.7056 6.41339C19.4376 6.09894 20.2249 5.93342 21.0216 5.9265C21.8183 5.91957 22.6083 6.07138 23.3457 6.37307C24.0831 6.67475 24.753 7.12027 25.3164 7.68363C25.8797 8.24698 26.3252 8.9169 26.6269 9.65427C26.9286 10.3917 27.0804 11.1817 27.0735 11.9784C27.0666 12.7751 26.9011 13.5624 26.5866 14.2944C26.2722 15.0264 25.8151 15.6885 25.242 16.242L15 26.4855L4.758 16.242C3.63317 15.1168 3.00128 13.591 3.00128 12C3.00128 10.409 3.63317 8.88316 4.758 7.758Z" />
                                            </svg>
                                        </button>
                                        <% }else{ %>
                                        <!-- ADMIN -->
                                        <button data-article="<%= article.getIdarticle() %>" data-display="no" class="editBtn p-3 bg-coolGray-100 rounded-20">
                                            <svg width="30" height="30" data-display="no" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <button data-display="no" class="deleteBtn p-3 bg-rose-100 rounded-20">
                                            <svg data-display="no" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="sideBar" class="w-650 bg-white sticky top-9 border-3 border-coolGray-100 rounded-40 py-9 px-11 hidden" style="height: fit-content;">
                        ...
                        <!-- EDIT / ADD -->
                        <% if(user.getRoleUtilisateur().equals("admin")){ %>
                            <div id="state_2" class="w-full h-full flex flex-col space-y-13 hidden">
                                <div>
                                    <!-- title EDIT-->
                                    <div id="_form_edit" class="flex flex-row items-center">
                                    ...
                                    <!-- title ADD-->
                                    <div id="_form_add" class="flex flex-row items-center">
