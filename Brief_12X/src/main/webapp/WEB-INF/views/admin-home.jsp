            ...
            <div class="w-full flex-1 pt-12 space-y-12 overflow-y-auto overflow-hidden flex flex-col">
                ...
                <div class="flex-1 bg-white grid grid-cols-home relative">
                    ...
                    <div class="tableColumn">
                        ...
                        <c:forEach items="${requestScope._logs}" var="log">
                            <div class="row data">
                                <!-- img -->
                                <div class="imgCont">
                                    <img src="<c:out value="${log.apprenant.imgApprenant}"/>" alt="" class="img">
                                </div>
                                <!-- info -->
                                <div class="infos">
                    ...
                    <div class="tableColumn">
                        ...
                        <c:forEach items="${requestScope._logs}" var="log">
                            <div class="row data">
                                <span class="infos"><c:out value="${log.apprenant.groupe.libelleGroupe}"/></span>
                            </div>
                        </c:forEach>
                    </div>
                    <!-- column -->
                    <div class="tableColumn">
                        ...
                        <c:forEach items="${requestScope._logs}" var="log">
                            <div class="row data option">
                                <span class="infos"><c:out value="${log.apprenant.promotion.libellePromotion}"/></span>
